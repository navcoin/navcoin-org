...
paragraphText="NavCoin 是一个开源协议，这意味着钱包是由一系列组织和个人维护的。有不同类型的钱包——从能让你完全控制并参与NavCoin网络的“full”钱包，到更容易使用的“light”钱包。永远记住，你有责任仔细选择你的钱包，并采取良好的做法，以保护你的&nbsp;钱"
buttonText="向社区寻求帮助"
...
{{< item_container_section
    ...
    {{< wallet
        ...
        text="NavPay是一个易于使用的轻钱包，它可以让你安全地储存你的导航。它可以在台式机和手机上使用，而且不占用gb的存储&nbsp;空间。"
    ...
    {{< wallet
        ...
        text="一个现代和时尚的NEXT钱包NavCoin。除了加注外，NEXT还提供了一个简单的界面，用于创建和投票社区资金&nbsp;提案。"
    ...
    {{< wallet
        ...
        text="Coinomi是一个安全第一的多重资产钱包，用于比特币、替代币和&nbsp;代币."
    ...
    {{< wallet
        ...
        text="基于树莓派平台的低能耗NavCoin full&nbsp;钱包。"
    ...
    {{< wallet
        ...
        text="一个高性能的NavCoin加注钱包，包括 NEXT钱包与diy&c&nbsp;选项。"
...
{{< item_container_section
    titleText="下载NavCoin Core 4.5.0"
    subtitleText="NavCoin Core钱包经过精心提炼，直观易用。它附带了一个安装向导，以及加载区块链并开始在安全环境中发送交易所需的&nbsp;一切。"
    bgPurple="正确的"
