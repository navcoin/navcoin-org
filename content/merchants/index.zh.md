...
{{< item_container_section
    titleText="商店"
    subtitleText="商人和服务的选择，让您花费自己的&nbsp;NavCoin"
>}}
    {{< merchant
        titleText="硬币支付"
        imgSrc="/images/merchants/mer-coinpayment.png"
        text="超过70家商户接受NAV使用coinpayment商户&nbsp;网关。"
...
>}}
    {{< action
        ...
        subtext="在你的智能手机上使用NavPay钱包。客户只需扫描二维码即可立即&nbsp;转账。"
        linkText="访问NavPay"
    ...
    {{< action
        ...
        subtext="集成了NavCoin支付网关，为shopify和woocommence等所有流行的网络购物车提供&nbsp;插件。"
    ...
    {{< action                 
        ...
        subtext="集成导航按钮的快速支付是一个很容易实现的选项，适合个人或&nbsp;业务。"
        linkText="这里是视图按钮"
